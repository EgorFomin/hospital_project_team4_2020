...
namespace HospitalProjectTeam4.Data
{
    ...
    public class HospitalProjectContext : IdentityDbContext<ApplicationUser>
    {
        ...
        {
            Database.SetInitializer<HospitalProjectContext>(null);
        ...
        public System.Data.Entity.DbSet<HospitalProjectTeam4.Models.Page> Pages { get; set; }

        public System.Data.Entity.DbSet<HospitalProjectTeam4.Models.ParkingSpot> ParkingSpots { get; set; }
    }
}